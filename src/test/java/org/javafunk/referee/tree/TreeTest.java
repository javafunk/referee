...
public class TreeTest {
    ...
    public void visitsAllNodesDepthFirst() {
        ...
        Node<Integer> firstChild = new Node<>("first-child", 11, firstGrandchild, secondGrandchild);
        Node<Integer> secondChild = new Node<>("second-child", 12, thirdGrandchild, fourthGrandchild);
        Node<Integer> rootNode = new Node<>("root", 1, firstChild, secondChild);
    ...
    public void mapsNodeValuesUsingSuppliedMapper() {
        ...
        Node<Integer> firstIntegerChild = new Node<>("first-child", 11, firstIntegerGrandchild, secondIntegerGrandchild);
        Node<Integer> secondIntegerChild = new Node<>("second-child", 12, thirdIntegerGrandchild, fourthIntegerGrandchild);
        Node<Integer> rootIntegerNode = new Node<>("root", 1, firstIntegerChild, secondIntegerChild);
        ...
        Node<String> firstStringChild = new Node<>("first-child", "11", firstStringGrandchild, secondStringGrandchild);
        Node<String> secondStringChild = new Node<>("second-child", "12", thirdStringGrandchild, fourthStringGrandchild);
        Node<String> rootStringNode = new Node<>("root", "1", firstStringChild, secondStringChild);
